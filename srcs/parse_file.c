...
/*   Updated: 2025/06/11 13:17:50 by hnakayam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	handle_duplicate_config(int has_config, char **error_msg,
		char *value)
{
	if (has_config)
	{
...
static int	process_config_by_type(t_config *config, int type,
